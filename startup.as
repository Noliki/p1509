	...
	; Compiler options:
	;
	; -o1509.cof -m1509.map --summary=default --output=default main.p1 \
	; --chip=16F1509 -IC:\Program Files (x86)\Microchip\MPASM Suite \
	; -ID:\_creatiff\_Projects\pic16f1509\fw -IC:\osa -P --runtime=default \
	; --opt=default,+asm,-debug,-speed,+space,9 --warn=0 -N255 \
